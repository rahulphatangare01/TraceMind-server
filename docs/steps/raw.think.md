our plan is we are making multiple DB in this project, Also microservice also we are intorducing,
so think like everything decouple.

1.  now we are develop every feature is module.
